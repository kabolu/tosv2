...
function sendEmail(){
	...
	document.location.href = "EmailNoticeServlet?type=CHANGEPEICE&studentNos="+studentNos+"&orderSeqNos="+orderSeqNos+"&isbn="+isbn+"";
}
//查看學員詳細信息
...
<input type="hidden" name="type" value="SEARCHCHANGED"/>
<table border="0">
  <tr>
    <td>圖書ISBN：</td>
    <td>
		...
		Student stud = (Student)studList.get(i);
    		...
    		<tr onmouseover="this.bgColor='#FFFFFF'" onmouseout="this.bgColor='#FFFBEF'" bgcolor="#FFFBEF" >
		      <td align="center">
		        ...
		        <input type="hidden" name="orderSeqNo" value="<%=stud.getOrder().getOrderSeqNo() %>" />
		      </td>
		      <td height="25">
