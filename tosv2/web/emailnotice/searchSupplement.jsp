...
function sendEmail(){
	...
	document.location.href = "EmailNoticeServlet?type=SUPPLEMENT&studentNos="+studentNos+"&orderSeqNos="+orderSeqNos+"&isbn="+isbn+"&isbnSeqNos="+isbnSeqNos+"";
}
...
<body>
  <h2>補訂教材到貨通知</h2>
  	<form action="StudentLackBookServlet" method="post" name="searchForm" onsubmit="return checkForm();">
  	  <input type="hidden" name="type" value="SEARCHSUPPLEMENT"/>
  	  <table border="0">
  	    <tr>
  	      <td>訂書日期：</td>
  	      <td>
