...
function sendEmail(){
	...
	document.location.href = "EmailNoticeServlet?type=UNPAIDORDER&studentNos="+studentNos+"&orderSeqNos="+orderSeqNos+"&isbn="+isbn+"&isbnSeqNos="+isbnSeqNos+"";
}
...
<body>
  <h2>未付款教材訂單的通知</h2>
  	<form action="StudentLackBookServlet" method="post" name="searchForm" onsubmit="return checkForm();">
  	  <input type="hidden" name="type" value="SEARCHUNPAIDORDER"/>
  	  <table border="0">
  	    <tr>
  	      <td>訂書日期：</td>
  	      <td>
