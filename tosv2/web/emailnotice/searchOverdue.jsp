...
function sendEmail(){
	...
	document.location.href = "EmailNoticeServlet?type=OVERDUE&studentNos="+studentNos+"&orderSeqNos="+orderSeqNos+"&isbn="+isbn+"&isbnSeqNos="+isbnSeqNos+"";
}
...
<body>
  <h2>逾期領取教材通知</h2>
  	<form action="StudentLackBookServlet" method="post" name="searchForm" onsubmit="return checkForm();">
  	  <input type="hidden" name="type" value="SEARCHOVERDUE"/>
  	  <table border="0">
  	    <tr>
  	      <td>訂書日期：</td>
  	      <td>
