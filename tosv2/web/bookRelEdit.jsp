...
<form action="CourseSearchServlet" method="post">
  <input type="hidden" name="oprType" value="edit" >
  <table width="500" align="center" border="0">
    <tr>
      ...
      <td width="150"><input type="submit" value="搜索"></td>
    </tr>
  </table>
</form>
<hr>
<form action="BookRelServlet" name="form1" method="post">
  ...
  %>
    <tr>
      <td colspan="3" align="center"><input type="button" onclick="checkBox();" value="添加"></td>
    </tr>
  <%
      }
  }catch(Exception e){
